...
export CONTAINER_ID=23  ## Should be exactly 2 numeric characters    
...
--name ${CONTANER_NAME}${CONTAINER_ID}        `# Container Name - should be unique` \
-p 1523:1521                                  `# Maps host_port:container_port for listener - use container port 1521` \
...
oracle/database:12.2.0.1.180717               `# Image Repository/tag`

docker logs -f  ${CONTANER_NAME}${CONTAINER_ID}
